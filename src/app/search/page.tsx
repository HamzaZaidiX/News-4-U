...
const Search = () => {
  ...
  useEffect(() => {
    ...
    const getNews = async () => {
      try {
        setLoading(true)
        const response = await fetch(`https://newsapi.org/v2/everything?apiKey=${process.env.NEXT_TOKEN_NEWS}&q=${search}&pageSize=10)`,{signal})
  ...
  return (
    <div className='w-[700px]'>
      {loading ? (
        <div className="items-center justify-center min-h-screen bg-gray-100 block">
